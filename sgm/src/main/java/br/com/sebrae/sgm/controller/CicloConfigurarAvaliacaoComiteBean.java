...
@ConversationScoped
@Named
public class CicloConfigurarAvaliacaoComiteBean extends BaseBean {

	private static final long serialVersionUID = 1L;

	private static Logger log = LoggerFactory.getLogger(CicloConfigurarAvaliacaoComiteBean.class);
	...
	private void verificarStatus() {
		if (this.cicloConfiguracao.getConfiguracaoComite() != null
				&& this.cicloConfiguracao.getConfiguracaoComite().getItemsAvaliados() != null
				&& this.cicloConfiguracao.getConfiguracaoComite().getItemsAvaliados().size() > 0) {
