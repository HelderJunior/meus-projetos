...
public abstract class FacesUtil {
	 ...
	 *            the msg.
	 */
	public static void addErrorMessage(final List<String> msgs) {
		for (String msg : msgs) {
			addErrorMessage(null, msg);
		}
	}
	...
	public static void addErrorMessage(String clientId, final List<String> msgs) {
		for (String msg : msgs) {
	...
	public static Object getBean(String nomeBean) {
		...
		return getFacesContext().getApplication().getELResolver().getValue(elContext, null, nomeBean);
	}
}