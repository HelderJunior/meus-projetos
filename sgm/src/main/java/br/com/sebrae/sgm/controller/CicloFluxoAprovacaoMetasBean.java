...
@ConversationScoped
@Named
public class CicloFluxoAprovacaoMetasBean extends BaseBean {

	private static final long serialVersionUID = 1L;

	private static Logger log = LoggerFactory.getLogger(CicloFluxoAprovacaoMetasBean.class);
