...
@ConversationScoped
@Named
public class CicloConfigurarExibicaoMetasDesenvolvimentoBean extends BaseBean {

	private static final long serialVersionUID = 1L;

	private static Logger log = LoggerFactory.getLogger(CicloConfigurarExibicaoMetasDesenvolvimentoBean.class);
